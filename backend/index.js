...
const fs = require('fs');
// Load env from backend/.env explicitly (fallback to process env if missing)
const dotenvResult = require('dotenv').config({ path: path.resolve(__dirname, '.env') });
if (dotenvResult.error) {
    console.warn('No backend/.env file found; relying on existing environment variables.');
}
